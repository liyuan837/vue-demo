...
exports.default = {
    data: function data() {
        return {
            price: 0, num: 0, discount: 0
        };
    },

    computed: {
        sum: function sum() {
            //如果当函数内涉及到的this.相关属性发生改变之后触发，并返回一个值，可以是对象
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_styles_global_css__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_styles_global_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__assets_styles_global_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mint_ui__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_mint_ui_lib_style_css__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_axios__ = __webpack_require__(34);
...
//[2]添加默认请求地址
__WEBPACK_IMPORTED_MODULE_5_axios___default.a.defaults.baseURL = 'http://127.0.0.1:8080/news/'

//拦截器：在每一次请求发送前都会被拦截
__WEBPACK_IMPORTED_MODULE_5_axios___default.a.interceptors.request.use(function(config){
    __WEBPACK_IMPORTED_MODULE_3_mint_ui___default.a.Indicator.open()
    return config//返回没有修改的配置，如果返回false或者不返回config就是直接拦截请求了
})

//拦截器：再响应回来之后被拦截
__WEBPACK_IMPORTED_MODULE_5_axios___default.a.interceptors.response.use(function(config){

    __WEBPACK_IMPORTED_MODULE_3_mint_ui___default.a.Indicator.close()
    return config
})
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8dc102fe_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__ = __webpack_require__(21);
...
/* scopeId */
var __vue_scopeId__ = "data-v-8dc102fe"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_app_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8dc102fe_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8dc102fe_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__["b" /* staticRenderFns */],
...
var update = add("68e099da", content, true, {});
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_vm._v("\n    单价："),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.price),expression:"price"}],attrs:{"type":"text"},domProps:{"value":(_vm.price)},on:{"input":function($event){if($event.target.composing){ return; }_vm.price=$event.target.value}}}),_vm._v("*\n    数量："),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.num),expression:"num"}],attrs:{"type":"text"},domProps:{"value":(_vm.num)},on:{"input":function($event){if($event.target.composing){ return; }_vm.num=$event.target.value}}}),_vm._v("*\n    折扣："),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.discount),expression:"discount"}],attrs:{"type":"text"},domProps:{"value":(_vm.discount)},on:{"input":function($event){if($event.target.composing){ return; }_vm.discount=$event.target.value}}}),_vm._v("=\n    "+_vm._s(_vm.sum)+"\n")])}
var staticRenderFns = []
...
module.exports = __webpack_require__.p + "background-aaa.png";
